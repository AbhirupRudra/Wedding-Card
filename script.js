...
const startHold = (e) => {
    ...
    instructionText.innerText = "Unsealing...";
...
const endHold = () => {
    ...
    instructionText.innerText = "Press & Hold to Unseal";
};
...
const timer = setInterval(() => {
    ...
    // Safety check if elements exist (in case of page changes)
    ...
    if (distance < 0) {
        ...
        if(countdownEl) countdownEl.innerHTML = "<h3>It's Happening!</h3>";
    }
}, 1000);
